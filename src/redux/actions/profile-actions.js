...
export const saveProfilePictureSuccess = (pics) => ({ type: types.SAVE_PROFILE_PICTURE_SUCCESS, pics });
export const saveProfileInfoSuccess = (profile) => ({ type: types.SAVE_PROFILE_INFO_SUCCESS, profile });
