...
const UsersContainer = () => {
    const { usersData, pageSize, totalUserCount, currentPage, isFetching }: UsersSelector =
        useAppSelector(usersPageSelector, shallowEqual)
    ...
    return (
        <div className='users-container'>
            ...
            {isFetching ? (
                ...
                <Users users={usersData} followUser={follow} unfollowUser={unfollow} />
            )}
        </div>
    )
}
