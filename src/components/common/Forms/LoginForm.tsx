        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='login-input-area'>
                <input
                    ...
                    placeholder='E-mail'
                />
                {errors.email && <div className='login-input-error'>{errors.email.message}</div>}
            </div>
            ...
            <div className='login-input-area'>
                ...
                />
                {errors.password && (
                    <div className='login-input-error'>{errors.password.message}</div>
                )}
            </div>
            ...
            {captcha && (
                <div className='captcha-area'>
                    ...
                    <input
                        className={errors.captcha ? 'captcha-input red-border' : 'captcha-input'}
                        {...register('captcha', {
                            required: {
                                value: true,
                    ...
                    />
                    {errors.captcha && (
                        <div className='captcha-error'>{errors.captcha.message}</div>
                    )}
                </div>
            )}

            {errors.server && <div className='login-input-error '>Incorrect email or password</div>}
